...
//Re written by Michael Stout to be more like how i would do it because this code is really annoying me now
...
public class WeightedRandomiser<T>
{
    ...
    public WeightedRandomiser(Dictionary<T, int> weights, int seed)
    {
